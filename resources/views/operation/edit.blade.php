<div class="modal fade" id="edit{{$operation}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <form action="{{route('operation.update',$operation->id)}}" method="post" autocomplete="off">
                ...
                <div class="modal-body">
                    ...
                    <input type="text" name="job_name" value="{{$operation->job_name}}" class="form-control" required>
                </div>
